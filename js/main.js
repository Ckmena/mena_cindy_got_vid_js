(() => {
	...
	// this is a conatainer  for some dinamic data (march 25) it has to be back tick --> `` <-- MULTIDIMENTIONAL ARRAY - ARRAY INSIDE AN ARRAY--
	const houseData = [
	...
	function animateBanner(){
		...
		//change the text conten on the page per house ** MULTIDIMENTIONALARRAY**
